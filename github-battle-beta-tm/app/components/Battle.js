                ...
                {({ theme }) => (
                    <form className='column player' onSubmit={this.handleSubmit}>
                        ...
                        <div className='row player-inputs'>
                            ...
                            />
                            <button className={`btn ${theme === 'dark' ? 'light-btn' : 'btn dark-btn'}`} type='submit' disabled={!this.state.username}>
                                Submit
                    </button>
                        </div>
                    </form>
            ...
            <React.Fragment>
                ...
                <div className='players-container'>
                    ...
                    <div className='row space-around'>
                        {playerOne === null
                            ? (
                                <PlayerInput label='Player 1' onSubmit={(player) => this.handleSubmit('playerOne', player)} />
                            )
                            : (
                        ...
                        {playerTwo === null
                            ? (
                                <PlayerInput label='Player 2' onSubmit={(player) => this.handleSubmit('playerTwo', player)} />
                            )
                            : (
